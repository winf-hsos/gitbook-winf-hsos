...
* [Wirtschaftsinformatik](bachelor/wirtschaftsinformatik/README.md)
  ...
  * [\#4 Coding - Superpower der digitalen Welt](bachelor/wirtschaftsinformatik/coding-superpower-der-digitalen-welt/README.md)
    ...
    * [Programmieren](bachelor/wirtschaftsinformatik/coding-superpower-der-digitalen-welt/programmieren.md)
  * [\#5 Daten - Produkt der digitalen Welt](bachelor/wirtschaftsinformatik/daten-produkt-der-digitalen-welt/README.md)
    ...
    * [Meine Daten](bachelor/wirtschaftsinformatik/daten-produkt-der-digitalen-welt/meine-daten.md)
...
* [Tutorials](script/tutorials/README.md)
  * [Einführung SQL](script/tutorials/einfuehrung-sql/README.md)
    * [\#0 Workspace Setup](script/tutorials/einfuehrung-sql/0-workspace-setup.md)
    * [\#1 Der SELECT Befehl](script/tutorials/einfuehrung-sql/1-der-select-befehl.md)
    * [\#2 Mehrere Tabellen](script/tutorials/einfuehrung-sql/2-mehrere-tabellen.md)
    * [\#3 Mengenoperationen](script/tutorials/einfuehrung-sql/3-mengenoperationen.md)
    * [\#4 Unterabfragen](script/tutorials/einfuehrung-sql/4-unterabfragen.md)
    * [\#5 Window-Funktionen](script/tutorials/einfuehrung-sql/5-window-funktionen.md)
    * [\#6 Texte](script/tutorials/einfuehrung-sql/6-texte.md)
    * [\#7 Statistische Funktionen](script/tutorials/einfuehrung-sql/7-statistische-funktionen.md)
    * [\#8 Datum und Zeit](script/tutorials/einfuehrung-sql/8-datum-und-zeit.md)
  ...
  * [Einführung in Markdown](script/tutorials/einfuehrung-in-markdown.md)
