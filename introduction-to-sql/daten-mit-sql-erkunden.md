...
![Die Anzahl Talks pro Event als Area-Chart.](../.gitbook/assets/image%20%2830%29.png)
...
{% hint style="info" %}
Neben dem Jahr oder Monat könnt ihr auch andere Datumsbestandteile extrahieren. Schaut dazu in den Teil [\#8 Datum und Zeit](../date-and-time-with-sql.md) des einführenden SQL Tutorials.
{% endhint %}
