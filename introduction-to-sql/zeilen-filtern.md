...
Für solche komplexere Anwendungen verweise ich auf den Abschnitt [\#8 Datum und Zeit](../self-learning/datenanalyse/einfuehrung-sql/8-datum-und-zeit.md), in dem spezielle Funktionen für den Umgang mit Datums- und Zeitwerten eingeführt werden.
